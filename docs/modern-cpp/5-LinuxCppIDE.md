...
Visual Studio Code [主页]([https://www.visualstudio.com](https://www.visualstudio.com/) )
...
JetBrains CLion [主页]( https://www.jetbrains.com/clion/) 
...
![JetBrains CLion](./images/JetBrainsCLion.png)

### 5.3 Eclipse CDT (C/C++ Development Tooling)

Eclipse CDT[主页](http://www.eclipse.org/cdt/)
...
![Eclipse CDT](./images/Eclipse.png)

### 5.4 CodeLite IDE

CodeLite [主页](http://codelite.org/)
...
![CodeLite](./images/CodeLite.png)

### 5.5 Code::Blocks

Code::Blocks [主页](http://www.codeblocks.org)
...
### 5.6 用于 C/C++ 开发的 Netbeans

Netbeans [主页](https://netbeans.org/features/cpp/index.html)
...
Bluefish [主页](http://bluefish.openoffice.nl )
...
Atom [主页](https://atom.io/)

Atom [安装指南](http://www.tecmint.com/atom*text*and*source*code*editor*for*linux/)
...
### 5.10 Sublime Text 编辑器

Sublime Text [主页](https://www.sublimetext.com)

Sublime Text [安装指南](http://www.tecmint.com/install*sublime*text*editor*in*linux/)
...
KDevelop [主页](https://www.kdevelop.org)
...
![KDevelop](./images/KDevelop.png)

### 5.12 Geany IDE

Geany [主页](http://www.geany.org/)
...
### 5.13 Ajunta DeveStudio

Ajunta DeveStudio [主页](http://anjuta.org/)
...
![Ajunta DeveStudio](./images/AjuntaDeveStudio.png)

### 5.14 GNAT Programming Studio

GNAT Programming Studio [主页](http://libre.adacore.com/tools/gps/)
...
![GNAT Programming Studio](./images/GNAT.jpg)

### 5.15 Qt Creator

Qt Creator [主页](https://www.qt.io/ide/)
...
![Qt Creator](./images/QtCreator.png)

### 5.16 Emacs 编辑器

Emacs [主页](https://www.gnu.org/software/emacs/)
